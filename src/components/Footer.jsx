...
const Footer = () => {
  return (
    <footer className="relative w-full aspect-video max-h-[60vh] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 mx-auto max-w-7xl px-6 py-8 md:py-10 flex items-center justify-between">
        <p className="text-[10px] md:text-xs tracking-[0.25em] uppercase font-medium text-neutral-400">
